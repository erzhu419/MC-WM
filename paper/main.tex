...
\paragraph{(E2) Controlled P1 isolation.}
The variance reduction from $24\%$ to $9\%$ attributed to P1 in
Section~\ref{sec:rahd} is observed across configurations that differ
in seed and several other parameters.  We will rerun MC-WM with
identical seeds, identical RAHD-A/B/C settings, identical P0, and only
P1 toggled, and report the seed distribution of returns.
